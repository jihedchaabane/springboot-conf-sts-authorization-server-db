pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'jihed123/springboot-conf-sts-authorization-server-db:0.0.1-SNAPSHOT'
        // Nom du conteneur
...
//                            -Dsonar.projectName=springboot-conf-sts-authorization-server-db \
//                            -Dsonar.projectKey=springboot-conf-sts-authorization-server-db
//                    '''
//                }
//            }
//        }
